...
AS
	...
	ELSE
		BEGIN
			SELECT message = 'El registro se ha incresado correctamente', nextId = IDENT_CURRENT('Especialidad') + IDENT_INCR('Especialidad'), ok = 1
...
AS
	...
	ELSE 
		BEGIN
			SELECT message = 'El registro se ha incresado corrnextnte', nextId = IDENT_CURRENT('Medico') + IDENT_INCR('Medico'), ok = 1
...
AS
	...
	ELSE
		BEGIN
			SELECT message = 'El registro se ha incresado conextmente', nextId = IDENT_CURRENT('Roles') + IDENT_INCR('Roles'), ok = 1
...
AS
	...
	ELSE 
		BEGIN
			SELECT message = 'El registro se ha incresado correctamente', nextId = IDENT_CURRENT('Medico_Especialidad') + IDENT_INCR('Medico_Especialidad'), ok = 1
...
AS
	...
	ELSE
		BEGIN
			SELECT message = 'El registro se ha incresado corrnextnte', nextId = IDENT_CURRENT('Unidad') + IDENT_INCR('Unidad'), ok = 1
...
AS
	...
	ELSE
		BEGIN
			SELECT message = 'El registro se ha incresado correcnexte', nextId = IDENT_CURRENT('Sintoma') + IDENT_INCR('Sintoma'), ok = 1
...
AS
	...
	ELSE
		BEGIN
			SELECT message = 'El registro se ha incresado correctanext', nextId = IDENT_CURRENT('Paciente') + IDENT_INCR('Paciente'), ok = 1
...
AS
	...
	ELSE
		BEGIN
			SELECT message = 'El registro se ha incresado correctanext', nextId = IDENT_CURRENT('Consulta') + IDENT_INCR('Consulta'), ok = 1
...
AS
	...
	ELSE
		BEGIN
			SELECT message = 'El registro se ha incresado correctanext', nextId = IDENT_CURRENT('Presenta') + IDENT_INCR('Presenta'), ok = 1
...
AS
	...
	ELSE
		BEGIN
			SELECT message = 'El registro se ha incresado correctamente', nextId = IDENT_CURRENT('Enfermedad') + IDENT_INCR('Enfermedad'), ok = 1
...
AS
	...
	ELSE
		BEGIN
			SELECT message = 'El registro se ha incresado corrnextnte', nextId = IDENT_CURRENT('Padece') + IDENT_INCR('Padece'), ok = 1
...
AS
	...
	ELSE
		BEGIN
			SELECT message = 'El registro se ha incresado correctamente', nextId = IDENT_CURRENT('Tipo_Intervencion') + IDENT_INCR('Tipo_Intervencion'), ok = 1
...
AS
	...
	ELSE
		BEGIN
			SELECT message = 'El registro se ha incresado correctamente', nextId = IDENT_CURRENT('Intervenciones') + IDENT_INCR('Intervenciones'), ok = 1
