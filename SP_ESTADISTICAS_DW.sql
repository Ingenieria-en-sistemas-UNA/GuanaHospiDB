...
AS
		SELECT TOP 3 u.nombre_unidad, u.numero_planta, 'Cantidad' = COUNT(c.id_unidad), c.id_unidad
...
AS
	SELECT TOP 5 m.codigo_medico, p.dni_persona, p.nombre_persona, p.apellido_1, 
		p.apellido_2, 'Cantidad' = COUNT(i.id_intervencion), ti.id_tipo_intervencion,
		ti.nombre_tipo_intervencion
		...
		INNER JOIN DW_GUANA_HOSPI.DBO.Tipo_Intervencion ti ON ti.id_tipo_intervencion = i.id_intervencion 
